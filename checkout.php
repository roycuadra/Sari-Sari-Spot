   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='order-detail'>
            ...
            <span style='background-color:green;' class='total'> total : $".$price_total."</span>
         </div>
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      ?>
      <span class="grand-total" style="background-color:green;"> grand total : ₱<?= $grand_total; ?></span>
   </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g. Surigao Del Norte" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
